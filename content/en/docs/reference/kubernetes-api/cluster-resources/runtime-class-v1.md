...
- **overhead** (Overhead)
  ...
  <a name="Overhead"></a>
  _Overhead structure represents the resource overhead associated with running a pod._
...
- **scheduling** (Scheduling)
  ...
  <a name="Scheduling"></a>
  _Scheduling specifies the scheduling constraints for nodes supporting a RuntimeClass._
