...
A Kubernetes [_Pod_](/docs/concepts/workloads/pods/) is a group of one or more Containers,
tied together for the purposes of administration and networking. The Pod in this
tutorial has only one Container. A Kubernetes
[_Deployment_](/docs/concepts/workloads/controllers/deployment/) checks on the health of your
