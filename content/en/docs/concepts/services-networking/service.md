...
metadata:
  name:
    my-service-1 # by convention, use the name of the Service
...
ports:
  - name:
      "" # empty because port 9376 is not assigned as a well-known
      # port (by IANA)
    appProtocol: http
    protocol: TCP
    port: 9376
...
Pods, you must create the Service _before_ the client Pods come into existence.
